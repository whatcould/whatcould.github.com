...
I made minor modifications to autotest and the engines plugin, so until (?) those changes get pulled into the main streams, *you'll have to use my forks* of those two libraries (or pull in my last commits to your own forks).
...
* "Engines plugin":http://github.com/whatcould/engines/tree/master  This just patches the copy-fixtures-to-temporary-directory behavior; if you don't have fixtures in your engines, you don't need these changes and you can keep your current Engines plugin.
